<%-- 
    ...
    Created on : 13-dic-2021, 18:54:12
    Author     : roger
--%>
...
<head>
    ...
    <title>AgregarNuevoProducto</title>
</head>
        ...
        <div class="card col-sm-6">
            <div class="card-body">
                <form action="Controlador?menu=Producto" method="POST">
                    <div class="form-group"><label for="">NombrePlatillo</label><input type="text"
                            value="${producto.getNomb()}" name="txtNombres" id="txtNombres" class="form-control"></div>
                    <div class="form-group"><label for="">Precio Del Platillo</label><input type="text" value="${producto.getPrecio()}"
