<%-- 
    ...
    Created on : 13-dic-2021, 18:35:04
    Author     : roger
--%>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group d-flex">
                            <div class="col-sm-4 d-flex">
                                <input type="text" name="precio" id="precio" class="form-control" value="${producto.getPrecio()}" placeholder="$. 0.00">
                            </div>
                            <div class="col-sm-3">
            ...
            <div class="card">
                ...
                <div class="card-footer d-flex">
                    ...
                    <div class="col-sm-4 ml-auto">
                        <input type="text" name="txtTotal" id="txtTotal" class="form-control text-center font-weight-bolder" value="$. ${totalPagar}">
                    </div>
                </div>
            </div>
        </div>
